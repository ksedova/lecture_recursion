...
def recursive_binary_search(seq, num, left_index, right_index):
    ...
    if num == seq[middle]:
        ...
        return recursive_binary_search(seq, num, left_index, middle - 1)
    elif num > seq[middle]:
        return recursive_binary_search(seq, num, middle + 1, right_index)
